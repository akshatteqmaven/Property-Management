!(function () {
  ...
  (ao.scale.pow = function () {
    ...
    (ao.scale.property_category10 = function () {
      return ao.scale.ordinal().range(Al);
    }),
    (ao.scale.property_category20 = function () {
      return ao.scale.ordinal().range(Cl);
    }),
    (ao.scale.property_category20b = function () {
      return ao.scale.ordinal().range(zl);
    }),
    (ao.scale.property_category20c = function () {
