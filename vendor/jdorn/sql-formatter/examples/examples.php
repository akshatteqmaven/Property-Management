...
<body>
    ...
    GROUP BY Column1 ORDER BY Column3 DESC LIMIT 5,10",
        ...
        "select * from `Table`, (SELECT group_concat(column1) as col FROM Table2 GROUP BY property_category)
    Table2, Table3 where Table2.col = (Table3.col2 - `Table`.id)",
        ...
        "UPDATE MyTable SET name='sql', property_category='databases' WHERE id > '65'",
